...
REMOTE_URL="${ST_CHARACTER_WECHAT_CODEX_ENDPOINT:-ws://127.0.0.1:${PORT}}"
STATE_DIR="${ST_CHARACTER_WECHAT_STATE_DIR:-$HOME/.st-character-wechat}"
SESSION_FILE="${ST_CHARACTER_WECHAT_SESSIONS_FILE:-${STATE_DIR}/sessions.json}"
WORKSPACE_ROOT="${ST_CHARACTER_WECHAT_WORKSPACE_ROOT:-$PWD}"
ACCOUNT_DIR="${STATE_DIR}/accounts"
RUNTIME_ID="${ST_CHARACTER_WECHAT_RUNTIME:-codex}"
