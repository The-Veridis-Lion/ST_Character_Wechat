const { WhereaboutsToolHost } = require("./whereabouts-tool-host");
...
const PROJECT_TOOLS = [
  {
    name: "st_character_wechat_diary_append",
    description: "Append a diary entry into ST Character WeChat local diary storage.",
  ...
  {
    name: "st_character_wechat_reminder_create",
    description: "Create a reminder in ST Character WeChat.",
  ...
  {
    name: "st_character_wechat_system_send",
    description: "Queue an internal ST Character WeChat system trigger for the current bound workspace and chat.",
  ...
  {
    name: "st_character_wechat_channel_send_file",
  ...
  {
    name: "st_character_wechat_timeline_read",
  ...
  {
    name: "st_character_wechat_timeline_categories",
  ...
  {
    name: "st_character_wechat_timeline_proposals",
  ...
  {
    name: "st_character_wechat_timeline_write",
    description: "Write timeline events through the local timeline compatibility layer. Inspect the current day and taxonomy first when category ids, event nodes, or existing events are uncertain.",
  ...
  {
    name: "st_character_wechat_timeline_build",
    description: "Build the timeline site through the local timeline compatibility layer.",
  ...
  {
    name: "st_character_wechat_timeline_serve",
    description: "Start the timeline static server through the local timeline compatibility layer.",
  ...
  {
    name: "st_character_wechat_timeline_dev",
    description: "Start the timeline dev server through the local timeline compatibility layer.",
  ...
  {
    name: "st_character_wechat_timeline_screenshot",
...
function validateTimelineWriteArgs(args) {
  ...
  events.forEach((event, index) => {
    ...
    if (!hasTitle && !hasEventNodeId) {
      throw new Error(`st_character_wechat_timeline_write input.events[${index}].title or input.events[${index}].eventNodeId is required.`);
    }
  });
}
