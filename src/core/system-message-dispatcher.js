...
function buildSystemInboundText(text, createdAt = "") {
  ...
  const sections = [
    ...
    "If you act, end with send_message that briefly and naturally reflects what you did or what changed; it does not need to continue the last unfinished topic if a fresher topic or status check fits better. Use silent only if you do nothing.",
